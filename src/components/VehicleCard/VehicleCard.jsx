...
import unavailableImg from "../../photos/bg/unavailable.webp";
  ...
  return (
    <div className={css.vehicleCard}>
      <div className={css.imgWrapper}>
        <img
          src={
            camper.gallery[0]?.thumb ? camper.gallery[0].thumb : unavailableImg
          }
          alt={camper.name}
      ...
      <div className={css.cardInfo}>
        <div className={css.cardTitle}>
          ...
          <p className={css.vehiclePrice}>€{Number(camper.price).toFixed(2)}</p>
          <div
